...
transfer_matterpower(2) = matterpow_49.dat
...
def camb_gen_quick(M_nu, omega_m, A_s9):
    print 'generating CAMB parameter files'
    '''M_nu: total mass of neutrinos in unit of eV
    A_s9 = A_s * 1e9
    modify omch2, omnuh2, scalar_amp(1)
...
transfer_high_precision = T
transfer_kmax           = 30 ## 1000 for columbia, 25 for S. Bird
transfer_k_per_logint   = 0
transfer_num_redshifts  = 7
transfer_interp_matterpower = T
...
accuracy_boost          = 1
l_accuracy_boost        = 1
l_sample_boost          = 1'''%(main_dir, filename, omch2, omnuh2, m1/M_nu, m2/M_nu, m3/M_nu, A_s9)
